    ...
    def update(self, cursor, bboxs):
        ...
        for x, bbox in enumerate(bboxs):
            ...
            if x1 < cursor[0] < x2 and y1 < cursor[1] < y2:
                self.userAns = x + 1
                cv2.rectangle(img, (x1, y1), (x2, y2), (162, 155, 254), cv2.FILLED)
...
def putTextRect(img, text, pos, scale=3, thickness=3, colorT=(255, 255, 255),
                colorR=(253, 121, 168), font=cv2.FONT_HERSHEY_PLAIN,
                offset=10, border=None, colorB=(178, 190, 195)):
    ox, oy = pos
...
while True:
    ...
    cv2.rectangle(img, (150, 600), (barValue, 650), (253, 121, 168), cv2.FILLED)
    cv2.rectangle(img, (150, 600), (1100, 650), (178, 190, 195), 5)
